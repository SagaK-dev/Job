...
public final class JobPlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        rewards = new RewardService(this, economy, beginners,
        ...
        JobCommand executor = new JobCommand(this, beginners, rewards);
        command.setExecutor(executor);
        command.setTabCompleter(executor);

        getLogger().info("Job 1.0.0 enabled. Beginner rewards are multiplied by "
                + beginners.beginnerMultiplier() + " for the first "
                + getConfig().getLong("beginner.duration-hours", 72L) + " hours.");
    }
